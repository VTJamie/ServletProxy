...
public class ProxyServlet extends HttpServlet
{
  ...
  @Override
  protected void service(HttpServletRequest servletRequest, HttpServletResponse servletResponse) throws RuntimeException, IOException, ServletException {
    // Make the Request
    ...
    if (servletRequest.getHeader(HttpHeaders.CONTENT_LENGTH) != null ||
        ...
        headerinfo = "Content length detected";
    ...
    try {
      ...
      System.out.println(proxyRequest.getAllHeaders());
      ...
      servletResponse.setHeader("attachment-exists-amengine", headerinfo);
